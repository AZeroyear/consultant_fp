...
ActiveRecord::Schema.define(version: 2019_05_25_000507) do
  ...
  create_table "time_settings", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "week"
    t.integer "interval"
    t.time "start"
    t.time "end"
